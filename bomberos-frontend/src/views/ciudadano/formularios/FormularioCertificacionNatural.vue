<template>
  <form @submit.prevent="enviar" class="space-y-6">
    <!-- FASE 3b — FORM-DNB-002 (legacy SIPPCI-NAT) -->
    <!-- Sección 1: Datos del Solicitante (formbns02: ci, expedido, mail, telefono) -->
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div>
          ...
          <input
            ...
            maxlength="100"
            required
            placeholder="Ej: solicitante@correo.com"
            class="w-full px-3 py-2 rounded-lg bg-gray-50 border border-gray-200 text-sm focus:outline-none focus:bg-white focus:ring-2 focus:ring-dnb-primary/30 transition-all"
          />
        </div>
    ...
    <!-- Sección 2: Ubicación (formbns02: ciudad, departamento, provincia, municipio) -->
    <div class="bg-white rounded-xl shadow-sm p-5">
      <h3 class="text-sm font-bold text-gray-900 uppercase tracking-wider mb-4 flex items-center gap-2">
    ...
    <!-- Sección 3: Depósito Bancario (formbns02: deposito, fdeposito, docs) -->
    <div class="bg-white rounded-xl shadow-sm p-5">
      <h3 class="text-sm font-bold text-gray-900 uppercase tracking-wider mb-4 flex items-center gap-2">
    ...
    <!-- Sección 4: Observaciones (formbns02: observaciones) -->
    <div class="bg-white rounded-xl shadow-sm p-5">
      <h3 class="text-sm font-bold text-gray-900 uppercase tracking-wider mb-4 flex items-center gap-2">
...
<script setup>
// FASE 3b: Formulario Certificación SIPPCI Natural (FORM-DNB-002 / legacy SIPPCI-NAT)
...
/** Campos reales del legacy formbnd02s (normalizados a snake_case) */
const form = ref({
  ci: '',
  expedido: '',
  correo: '',
  ...
  try {
    const payload = {
      ...
      datos_especificos: {
        ...
        // Metadata legacy: identifica el formulario fuente (formbns02)
        tipo_formulario: 'SIPPCI-NAT',
