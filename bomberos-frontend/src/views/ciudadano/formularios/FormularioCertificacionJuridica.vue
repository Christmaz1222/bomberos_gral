<template>
  <form @submit.prevent="enviar" class="space-y-6">
    <!-- FASE 3b — FORM-DNB-001 (legacy SIPPCI-JUR) -->
    <!-- Sección 1: Datos de la Entidad (formbns01: nombrers, nit, oficina, legal) -->
    ...
    <!-- Sección 2: Datos del Solicitante (formbns01: ci, expedido, mail, fono) -->
    <div class="bg-white rounded-xl shadow-sm p-5">
      <h3 class="text-sm font-bold text-gray-900 uppercase tracking-wider mb-4 flex items-center gap-2">
    ...
    <!-- Sección 3: Ubicación (formbns01: ciudad, depto, provincia, municipio) -->
    <div class="bg-white rounded-xl shadow-sm p-5">
      <h3 class="text-sm font-bold text-gray-900 uppercase tracking-wider mb-4 flex items-center gap-2">
    ...
    <!-- Sección 4: Depósito Bancario (formbns01: deposito, fdeposito, docs) -->
    <div class="bg-white rounded-xl shadow-sm p-5">
      <h3 class="text-sm font-bold text-gray-900 uppercase tracking-wider mb-4 flex items-center gap-2">
    ...
    <!-- Sección 5: Observaciones (formbns01: obs) -->
    <div class="bg-white rounded-xl shadow-sm p-5">
      <h3 class="text-sm font-bold text-gray-900 uppercase tracking-wider mb-4 flex items-center gap-2">
...
<script setup>
// FASE 3b: Formulario Certificación SIPPCI Jurídica (FORM-DNB-001 / legacy SIPPCI-JUR)
...
/** Campos reales del legacy formbnd01s (normalizados a snake_case) */
const form = ref({
  nombre_razon_social: '',
  nit: '',
  entidad_institucion: '',
  ...
  try {
    const payload = {
      ...
      datos_especificos: {
        ...
        // Metadata legacy: identifica el formulario fuente (formbns01)
        tipo_formulario: 'SIPPCI-JUR',
