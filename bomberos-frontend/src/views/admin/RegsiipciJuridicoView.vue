  ...
  <div class="min-h-screen bg-gray-100">
    ...
    <main class="container mx-auto p-6">
      <div class="max-w-4xl mx-auto bg-white p-8 rounded-xl shadow-lg border-t-4 border-red-800">
        <h1 class="text-2xl font-bold text-red-800 mb-6 uppercase">Registro de Certificación SIPPCI - Entidad Juridica</h1>
        
        <form @submit.prevent="guardarRegistro" class="space-y-6">
          
          <!-- Sección: Entidad -->
          <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <h2 class="col-span-full font-semibold text-gray-700 border-b pb-2">Datos de la Entidad</h2>
            <div class="field">
            ...
            <div class="col-span-full">
              ...
              <input v-model="form.razonSocial" class="w-full mt-1 p-2 border rounded-md" />
            </div>
            <div class="field">
            ...
            <div class="field">
              <label class="block text-sm font-medium text-gray-700">Entidad / Institución</label>
              <input v-model="form.entidad" class="w-full mt-1 p-2 border rounded-md" />
            </div>
          </div>

          <!-- Sección: Responsable Legal -->
          <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <h2 class="col-span-full font-semibold text-gray-700 border-b pb-2">Responsable Legal</h2>
            <div class="col-span-full">
              <label class="block text-sm font-medium text-gray-700">Nombre Responsable Legal</label>
              <input v-model="form.responsable" class="w-full mt-1 p-2 border rounded-md" />
            </div>
            <div class="field">
            ...
            <div class="field">
              ...
              <input v-model="form.expedido" class="w-full mt-1 p-2 border rounded-md" />
            </div>
            <div class="field">
            ...
            <div class="field">
              ...
              <input v-model="form.telefono" class="w-full mt-1 p-2 border rounded-md" />
            </div>
          </div>
