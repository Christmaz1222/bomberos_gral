<template>
  <div class="max-w-4xl mx-auto px-6 py-12 md:py-16">
    <div class="text-center max-w-2xl mx-auto mb-12">
      <span class="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-[11px] font-bold bg-red-50 text-red-700 mb-4 border border-red-100">
        Nuestra Trayectoria
      </span>
      <h1 class="text-3xl font-black tracking-tight text-slate-900 mb-3">Historia Institucional</h1>
      <p class="text-sm text-slate-500 leading-relaxed">
        Más de un siglo protegiendo la vida, el patrimonio y el medio ambiente con abnegación y disciplina.
      </p>
    </div>

    <div class="space-y-8 relative before:absolute before:inset-0 before:left-4 md:before:left-1/2 before:w-0.5 before:bg-slate-200">
      
      <div class="relative flex flex-col md:flex-row items-start md:justify-between group">
        <div class="absolute left-4 md:left-1/2 w-3 h-3 bg-red-600 rounded-full transform -translate-x-1.5 mt-1.5 border-4 border-white shadow-xs"></div>
        <div class="w-full md:w-[45%] pl-10 md:pl-0 md:text-right md:pr-8">
      ...
      <div class="relative flex flex-col md:flex-row items-start md:justify-between group">
        <div class="absolute left-4 md:left-1/2 w-3 h-3 bg-red-600 rounded-full transform -translate-x-1.5 mt-1.5 border-4 border-white shadow-xs"></div>
        <div class="hidden md:block w-[45%]"></div>
        <div class="w-full md:w-[45%] pl-10 md:pr-0 md:pl-8">
